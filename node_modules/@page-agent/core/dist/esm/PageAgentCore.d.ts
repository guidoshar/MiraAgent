...
export declare interface AgentConfig extends LLMConfig {
 ...
 */
export declare interface AgentErrorEvent {
    type: 'error';
    message: string;
    rawResponse?: unknown;
}
 ...
 */
export declare interface AgentStepEvent {
    type: 'step';
    stepIndex: number;
...
export declare type PageAgentCoreConfig = AgentConfig & {
 ...
 */
export declare interface RetryEvent {
    type: 'retry';
    message: string;
    attempt: number;
    maxAttempts: number;
...
export declare type SupportedLanguage = 'en-US' | 'zh-CN';
